...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark  bg-white mb-6 "  >
            <div class="container-fluid navbar-content">
               
                <a class="navbar-brand" href="?page=home"> <img src="images/logo.png" alt="Logo" class="app-logo"> </a>
